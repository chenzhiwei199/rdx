...
//  * @template IModel
//  */
// export interface IRdxReactionOperate<GModel> {
//   deps: IRdxAnyDeps[];
//   get: (config: { get: RdxGet }) => IModel | RdxNode<GModel> | Promise<GModel>;
//   set?: (
//     config: {
//       get: RdxGet;
//       set: RdxSet;
...
//   ) => void;
// }
// export type IRdxReactionNode<GModel> = IRdxNode & IRdxReactionOperate<GModel>;

// export class RdxReactionNode<GModel> extends RdxNode<GModel>
//   implements IRdxReactionOperate<GModel> {
...
//   constructor(config: IRdxReactionNode<GModel>) {
...
//   }
// }
// export function reaction<GModel>(
//   config: IRdxReactionNode<GModel>
// ): RdxNode<GModel> {
