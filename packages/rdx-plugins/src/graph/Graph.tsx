...
// }
// export default abstract class Graph<IModel> extends React.Component<
//   IGraph<IModel>,
//   IGraphState
// > {
//   snapShots: ISnapShot[] = [];
//   temporarySnapShots: ISnapShot;
//   constructor(props: IGraph<IModel>) {
//     super(props);
//     this.state = {
//       version: 0,
//       visible: false,
...
//   }
//   componentDidMount() {
//     this.props.context.getSubject().on(TaskEventType.Init, (process) => {
//       this.initSnapShot(TaskEventType.Init);
//     });
//     this.props.context
//       .getSubject()
//       .on(TaskEventType.EventTrigger, (process) => {
//         this.initSnapShot(TaskEventType.EventTrigger);
//       });
//     this.props.context
//       .getSubject()
//       .on(TaskEventType.BatchEventTrigger, (process) => {
//         this.initSnapShot(TaskEventType.BatchEventTrigger);
//       });

//     this.props.context.getSubject().on(TaskEventType.TaskChange, (process) => {
//       this.initSnapShot(TaskEventType.TaskChange);
//     });
//     this.props.context
//       .getSubject()
//       .on(TaskEventType.ProcessRunningGraph, (process: ISnapShotTrigger) => {
...
//     const ee = this.props.context.getSubject();
